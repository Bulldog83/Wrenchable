...
public class WrenchableRegistry {
    ...
    private static <T> DefaultedRegistry<T> register(String string_1, String string_2) {
        Identifier identifier_1 = new Identifier(WrenchableMain.MODID, string_1);
        return new DefaultedRegistry<>(string_2, RegistryKey.ofRegistry(identifier_1), Lifecycle.stable());
    }
